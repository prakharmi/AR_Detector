...
An Android application designed for real-time product detection and inventory counting.<br>
[Download APK and Try Now](https://github.com/prakharmi/AR_Detector/raw/master/AR_Detector.apk)
...
5.  **Build & Run.**
    (Note - The ML model is already included in the assests folder)
